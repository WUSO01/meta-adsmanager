...
const insertRow = () => {
  ...
  wrapper.innerHTML = `
    <span data-surface-wrapper="1" data-surface="/am/table/table_row:120240218110860043unit" style="display: contents;">
      <div class="_1gda _2djg" style="width: 2444px; height: 46px; z-index: 0; transform: translate(0px, 46px);">
        <div class="_1gd4 _4li _4lo _52nn  _5a1n _3c7k x1es45g1" role="presentation" style="width: 2444px; height: 46px;">
          <div class="_1gd5">
            <div class="x10l6tqk x13vifvy" style="height: 46px; left: 0px;">
              <div class="_3pzj"
                style="height: 46px; position: absolute; width: 463px; will-change: transform; z-index: 2; transform: translate(0px, 0px);">
                <span data-surface-wrapper="1"
                  data-surface="/am/table/table_row:120240218110860043unit/table_cell:row_selector"
                            ...
                            <div class="x1rg5ohu x1n2onr6 x3oybdh">
                              <div class="x1n2onr6 x14atkfc">
                                <div
                                  ...
                                  </div><input aria-checked="false" aria-disabled="false" aria-label=""
                                    aria-describedby="js_f8" aria-labelledby="js_f9"
                  ...
                  data-surface="/am/table/table_row:120240218110860043unit/table_cell:forObjectType(toggle,CAMPAIGN)"
                  style="display: contents;">
                        ...
                        <div data-visualcompletion="ignore" class="">
                          <div>
                            <div class="x6s0dn4 x78zum5 x1q0g3np xozqiw3 x2lwn1j xeuugli x8va1my x1c4vz4f">
                              <div class="x1rg5ohu x1n2onr6 x3oybdh"><input aria-checked="true" aria-label="开/关"
                                  role="switch" aria-describedby="js_fc" aria-labelledby="js_fa"
                                  ...
                                  disabled="" id="js_fb" type="checkbox" value="true" checked="">
                                <div class="x1n2onr6 xh8yej3">
                                  <div
                                    ...
                                    <div
                                      class="xw4jnvo x1qx5ct2 x1iwo8zk x1033uif x179ill4 x1b60jn0 x13dflua x6o7n8i xxziih7 x12w9bfk xo1l8bm x19yxgo3 x60d0xz x1psfjxj">
                                    </div>
                                  </div>
                                  <div
                  ...
                  data-surface="/am/table/table_row:120240218110860043unit/table_cell:forObjectType(name,CAMPAIGN)"
                  style="display: contents;">
                  <div class="_4lg0 _4h2m" style="height: 46px; width: 320px; left: 143px;">
                    <div class=" _1b33" id="js_ff">
                      <div class="x9f619 x78zum5 xdj266r x14z9mp xat24cr x1lziwak">
                        <div class="x1iyjqo2 x6ikm8r x10wlt62">
                          <div class="x78zum5 x6s0dn4">
                            <div class="ellipsis _13is" data-hover="tooltip" data-tooltip-content="新销量广告组 - 广告副本"
                              ...
                              <div data-visualcompletion="ignore" class="xt0psk2"></div><span data-tracked="true"
                                data-interactable="|mousedown||click|"><a
                                  ...
                                  href="#"><span class="_3dfi _3dfj">新销量广告组 - 广告副本</span></a></span>
                            </div>
                            <div data-visualcompletion="ignore" class=""></div>
                          </div><span data-surface-wrapper="1"
                            data-surface="/am/table/table_row:120240218110860043unit/table_cell:forObjectType(name,CAMPAIGN)/maiba:ad_object_overflow_menu_entrypoint"
                            data-auto-logging-id="f3cc8ac1e" style="display: contents;">
                            <div data-visualcompletion="ignore" class="x1lliihq xlshs6z x1thohka">
                              <div class="x1lliihq">
                                <div style="display: flex;">
                                  ...
                                  <div aria-busy="false" aria-controls="js_fk" aria-expanded="false" aria-haspopup="menu"
            ...
            <div class="x10l6tqk x13vifvy" style="height: 46px; left: 463px;">
              <div class="_3pzj"
                style="height: 46px; position: absolute; width: 1991px; will-change: transform; z-index: 0; transform: translate(0px, 0px);">
                <span data-surface-wrapper="1"
                  data-surface="/am/table/table_row:120240218110860043unit/table_cell:forObjectType(delivery,CAMPAIGN)"
                  style="display: contents;">
                  <div class="_4lg0 _4h2m" style="height: 46px; width: 130px; left: 0px;">
                    <div class="_1b33">
                      <div class="xuxw1ft clearfix _ikh">
                        ...
                        <div class="_4bl9"><span
                            class="x1vvvo52 x1fvot60 xo1l8bm xxio538 xbsr9hj xq9mrsl x1h4wwuj xeuugli">广告系列已关闭</span></div>
                      </div>
                    </div>
                  </div>
                </span><span data-surface-wrapper="1"
                  data-surface="/am/table/table_row:120240218110860043unit/table_cell:recommendations_guidance"
                  style="display: contents;">
                  <div class="_4lg0 _4h2m" style="height: 46px; width: 160px; left: 130px;">
                    <div class="x5yr21d">
                  ...
                  data-surface="/am/table/table_row:120240218110860043unit/table_cell:forAttributionWindow(results,default)"
                  style="display: contents;">
                  <div class="_4lg0 _4lg5 _4h2p _4h2m" style="height: 46px; width: 146px; left: 290px;"><span>
                  ...
                  data-surface="/am/table/table_row:120240218110860043unit/table_cell:forAttributionWindow(cost_per_result,default)"
                  style="display: contents;">
                  <div class="_4lg0 _4lg5 _4h2p _4h2m" style="height: 46px; width: 146px; left: 436px;">
                    <div class=" _1b33 _av2o">
                      <div class="x1cy8zhl x78zum5 x1q0g3np x1nhvcw1 xozqiw3">
                        <div class="x1r8uery x1iyjqo2 xs83m0k xeuugli">
                          <div geotextcolor="value" data-hover="tooltip" data-tooltip-display="overflow"
                            ...
                            <span><span class="_3dfi _3dfj">$33.84</span></span></div>
                          <div class="ellipsis _1ha4" data-hover="tooltip" data-tooltip-display="overflow"
                            data-tooltip-text-direction="auto">
                  ...
                  data-surface="/am/table/table_row:120240218110860043unit/table_cell:forObjectType(budget,CAMPAIGN)"
                  style="display: contents;">
                  <div class="_4lg0 _4lg5 _4h2p _4h2m" style="height: 46px; width: 134px; left: 582px;"><span>
                      <div class=" _1b33 _av2o">
                        <div geotextcolor="value" data-hover="tooltip" data-tooltip-display="overflow"
                          data-tooltip-text-direction="auto"
                          class="x1vvvo52 x1fvot60 xo1l8bm xxio538 x1lliihq x6ikm8r x10wlt62 xlyipyv xuxw1ft xbsr9hj">
                          <span>使用广告系列预算</span></div>
                      </div>
                    </span></div>
                </span><span data-surface-wrapper="1"
                  data-surface="/am/table/table_row:120240218110860043unit/table_cell:spend" style="display: contents;">
                  <div class="_4lg0 _4lg5 _4h2p _4h2m" style="height: 46px; width: 146px; left: 716px;"><span>
                      <div class=" _1b33 _av2o">
                        <div geotextcolor="value" data-hover="tooltip" data-tooltip-display="overflow"
                          data-tooltip-text-direction="auto"
                  ...
                  data-surface="/am/table/table_row:120240218110860043unit/table_cell:impressions"
                  style="display: contents;">
                  <div class="_4lg0 _4lg5 _4h2p _4h2m" style="height: 46px; width: 146px; left: 862px;">
                    <div class=" _1b33 _av2o _1b33">
                      <div geotextcolor="value" data-hover="tooltip" data-tooltip-display="overflow"
                        data-tooltip-text-direction="auto"
                        class=" _as5y x1vvvo52 x1fvot60 xo1l8bm xxio538 x1lliihq x6ikm8r x10wlt62 xlyipyv xuxw1ft xbsr9hj">
                        <span>1,477</span></div>
                  ...
                  data-surface="/am/table/table_row:120240218110860043unit/table_cell:reach" style="display: contents;">
                  <div class="_4lg0 _4lg5 _4h2p _4h2m" style="height: 46px; width: 146px; left: 1008px;">
                    <div class=" _1b33 _av2o _1b33">
                      <div geotextcolor="value" data-hover="tooltip" data-tooltip-display="overflow"
                        data-tooltip-text-direction="auto"
                        class=" _as5y x1vvvo52 x1fvot60 xo1l8bm xxio538 x1lliihq x6ikm8r x10wlt62 xlyipyv xuxw1ft xbsr9hj">
                  ...
                  data-surface="/am/table/table_row:120240218110860043unit/table_cell:schedule" style="display: contents;">
                  <div class="_4lg0 _4h2m" style="height: 46px; width: 300px; left: 1154px;">
                    <div class=" _1b33 _av2o">
                      <div geotextcolor="value" data-hover="tooltip" data-tooltip-display="overflow"
                        data-tooltip-text-direction="auto"
                        class="x1vvvo52 x1fvot60 xo1l8bm xxio538 x1lliihq x6ikm8r x10wlt62 xlyipyv xuxw1ft xbsr9hj"><span
                          data-hover="tooltip" data-tooltip-content="2026年2月21日 09:59 – 长期">
                          <div data-visualcompletion="ignore" class=""></div>2026年2月21日 – 长期
                        </span></div>
                    </div>
                  </div>
                </span><span data-surface-wrapper="1"
                  data-surface="/am/table/table_row:120240218110860043unit/table_cell:forObjectType(end_time,CAMPAIGN)"
                  style="display: contents;">
                  <div class="_4lg0 _4lg5 _4h2p _4h2m" style="height: 46px; width: 113px; left: 1454px;">
                    <div class=" _1b33 _av2o">
                      <div geotextcolor="value" data-hover="tooltip" data-tooltip-display="overflow"
                        data-tooltip-text-direction="auto"
                  ...
                  data-surface="/am/table/table_row:120240218110860043unit/table_cell:attribution_setting"
                  style="display: contents;">
                  <div class="_4lg0 _4h2m" style="height: 46px; width: 120px; left: 1567px;"><span>
                      <div class=" _1b33 _av2o">
                        <div geotextcolor="value" data-hover="tooltip" data-tooltip-display="overflow"
                          data-tooltip-text-direction="auto"
                          class="x1vvvo52 x1fvot60 xo1l8bm xxio538 x1lliihq x6ikm8r x10wlt62 xlyipyv xuxw1ft xbsr9hj">
                  ...
                  data-surface="/am/table/table_row:120240218110860043unit/table_cell:forObjectType(bid,CAMPAIGN)"
                  style="display: contents;">
                  <div class="_4lg0 _4lg5 _4h2p _4h2m" style="height: 46px; width: 134px; left: 1687px;">
                    <div class=" _1b33 _av2o">
                      <div geotextcolor="value" data-hover="tooltip" data-tooltip-display="overflow"
                        data-tooltip-text-direction="auto"
                        class="x1vvvo52 x1fvot60 xo1l8bm xxio538 x1lliihq x6ikm8r x10wlt62 xlyipyv xuxw1ft xbsr9hj"><span>
                          <div data-visualcompletion="ignore" class=""></div><span class="x108nfp6">最高数量</span>
                        </span></div>
                      <div class="ellipsis _1ha4" data-hover="tooltip" data-tooltip-display="overflow"
                        data-tooltip-text-direction="auto">
                        <div class="xt0psk2 x1vvvo52 xw23nyj xo1l8bm x63nzvj x1541jtf">转化量</div>
                      </div>
                    </div>
                  </div>
                </span><span data-surface-wrapper="1"
                  data-surface="/am/table/table_row:120240218110860043unit/table_cell:forObjectType(last_significant_edit,CAMPAIGN)"
                  style="display: contents;">
                  <div class="_4lg0 _4h2m" style="height: 46px; width: 138px; left: 1821px;">
                    <div class=" _1b33 _av2o">
                      <div geotextcolor="value" data-hover="tooltip" data-tooltip-display="overflow"
                        data-tooltip-text-direction="auto"
                        class="x1vvvo52 x1fvot60 xo1l8bm xxio538 x1lliihq x6ikm8r x10wlt62 xlyipyv xuxw1ft xbsr9hj">
                        <span>2026年2月21日 10:00</span></div>
                      <div class="ellipsis _1ha4" data-hover="tooltip" data-tooltip-display="overflow"
                        data-tooltip-text-direction="auto">
                        <div class="xt0psk2 x1vvvo52 xw23nyj xo1l8bm x63nzvj x1541jtf">23天前</div>
                      </div>
                    </div>
                  </div>
                </span><span data-surface-wrapper="1"
                  data-surface="/am/table/table_row:120240218110860043unit/table_cell:suggestions_toggle"
                  style="display: contents;">
                  <div class="_4lg0 _4h2m" style="height: 46px; width: 32px; left: 1959px;">
                    <div class="_1b33"></div>
                  </div>
                </span></div>
            </div>
            <div class="_1gd6 _1gd8" style="left: 463px; height: 46px;"></div>
          </div>
        </div>
      </div>
    </span>
...
describe("extractAdsetData", () => {
  ...
  it("should extract Campaign row fields correctly", () => {
    ...
    const {data, domElements } = extract.extractAdsetData()
    ...
    expect(row.id).toBe("120240218110860043");
    expect(row.level).toBe('adsets')
    expect(row.status).toBe("开启");
    expect(row.name).toBe("新销量广告组 - 广告副本");
    expect(row.delivery).toBe("广告系列已关闭");
    expect(row.recommendations).toBe("—");
    expect(row.results).toEqual({ value: 1, type: "网站购物" });
    expect(row.cost_per_result).toEqual({ value: 33.84, type: "单次购物" });
    expect(row.budget).toBe("使用广告系列预算");
    expect(row.amount_spent).toBe(33.84);
    expect(row.impressions).toBe(1477);
  });
});
